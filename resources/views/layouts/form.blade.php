...
<div class="form-group row">
    <label for="pekerjaan" class="col-md-3 col-form-label text-md-right">Pekerjaan </label>
    <div class="col-md-6">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        ...
        <label class="custom-file-label col-md-12" for="gambar_profil" onchange="$('#gambar_profil').val($(this).val());">{{ $user->gambar_profil ?? 'Pilih gambar...'}}</label>
        @error('gambar_profil')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
