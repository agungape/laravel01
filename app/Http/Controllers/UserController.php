...
class UserController extends Controller
{
    ...
    {
    // xtract komponen tanggal_lahir dari MySQL, masukkan ke array $user
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect('/')->with(['pesan' => 'update','nama' => $user->nama]);
    }

    public function destroy(User $user)
    {
        $user->delete();
        return redirect('/')->with(['pesan' => 'delete', 'nama' => $user->nama]);
    }
}
