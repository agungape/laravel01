...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        // ambil request object untk proses upload file
        $request = request();

        //proses upload file gambar profile
        if ($request->hasFile('gambar_profil')){
            // gunakan slug helper agar "nama" bisa dipakai sebagai bagian dari gambar profil
            ...
            // proses upload, simpan kedalam folder "uploads"
